...
def test_gradient_clip_probe_notebook_is_executed_validation_only() -> None:
    path = (
    ...
    assert "Resultado del probe: **FAIL**" in rendered
    assert "Ratio final: **1843.0214**" in rendered
